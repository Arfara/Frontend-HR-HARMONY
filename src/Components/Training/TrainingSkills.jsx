  ...
  return (
    <div className="flex justify-between mx-10 my-10">
      ...
      <div className="w-2/3 ml-10">
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-blue-500 text-lg font-semibold mb-6">List All Training Skills</h2>
      ...
      {isEditModalOpen && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center" id="edit-training-skill-modal">
          <div className="bg-white p-6 rounded-md shadow-lg w-full max-w-md">
            <div className="flex justify-between items-center mb-5">
              <h4 className="text-lg font-semibold">Edit Training Skill Information</h4>
